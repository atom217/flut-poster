...
final List<Quote> dummyQuotes = [
  ...
  Quote(
    id: 'q2',
    text:
        'मैं उस धर्म को पसंद करता हूँ जो स्वतंत्रता, समानता और भाईचारा सिखाता है।',
    categoryId: 'sv',
  ),
  Quote(
    id: 'q3',
    text: 'जीवन लंबा होने के बजाय महान होना चाहिए।',
    categoryId: 'sv',
  ),
  Quote(
    id: 'q4',
    text: 'बुद्धि का विकास मानव के अस्तित्व का अंतिम लक्ष्य होना चाहिए।',
    categoryId: 'qt',
  ),
  Quote(
    id: 'q5',
...
final UserProfile dummyUser = UserProfile(
  name: 'Pushpendra Paliwal',
  subtitle: 'Jai Sia Ram',
);
...
final List<TemplateModel> dummyTemplates = [
  ...
  TemplateModel(
    ...
    categoryId: 'gm',
    gradientColors: [const Color(0xFFFFD180), const Color(0xFFFFAB40)],
  ),
  TemplateModel(
    id: 't4',
    name: 'Morning Sky',
    ...
    categoryId: 'gm',
    isPremium: true,
    gradientColors: [const Color(0xFF81D4FA), const Color(0xFF01579B)],
  ),
  ...
  TemplateModel(
    ...
    textColor: Colors.white,
    categoryId: 'gn',
    gradientColors: [const Color(0xFF1A237E), const Color(0xFF000000)],
  ),
  TemplateModel(
    id: 't6',
    name: 'Starry',
  ...
  TemplateModel(
    ...
    textColor: Colors.white,
    categoryId: 'bd',
    gradientColors: [const Color(0xFFF06292), const Color(0xFFE91E63)],
  ),
  TemplateModel(
    id: 't12',
    name: 'Gold',
    ...
    categoryId: 'bd',
    isPremium: true,
    gradientColors: [const Color(0xFFFFF176), const Color(0xFFFFD700)],
  ),
];
